...
class TaskController extends GetxController {
  ...
  Future<void> createTask(String goal) async {
    ...
    try {
      final planPrompt = '''You are an GHIAS Autonomous Agent (Kairo) planner. Given a user's goal, break it down into individual ADB shell commands to execute on an Android phone.
