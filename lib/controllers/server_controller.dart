...
import '../gateway/openai_server_service.dart';
import '../gateway/tunnel_service.dart';
  ...
  Future<void> startServer() async {
    ...
    try {
      ...
      await _server.start(
        ...
        systemPromptProvider: (modelName) => settings.effectiveSystemPromptForModel(modelName),
      );
